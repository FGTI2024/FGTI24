...
for seed in seeds:
    ...
    np.savetxt("Data/mask/physio/physiomar_" + str(missing_p) + "_" + str(seed) + ".csv", mar_mask, fmt="%d", delimiter=",")
    np.savetxt("Data/mask/physio/physiomnar_" + str(missing_p) + "_" + str(seed) + ".csv", mnar_mask, fmt="%d", delimiter=",")
